...
public class DA_Transfar
{
    private readonly IDbConnection _db;

    public DA_Transfar(IDbConnection db)
    {
        _db = db;
    }
    ...
    public async Task<string> CreateTransactionHistory(TransfarRequestModel reqModel)
    {
